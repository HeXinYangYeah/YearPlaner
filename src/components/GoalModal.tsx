...
import { X, Trash2, ArrowRight, Lightbulb, CheckCircle2, ChevronDown, ChevronUp, Edit2, Sparkles } from 'lucide-react';
...
export default function GoalModal({ domain, isOpen, onClose }: GoalModalProps) {
    ...
    const handleAdd = async (customTitle?: string) => {
        ...
        // Added goal successfully, do NOT trigger AI decomposition here.
        // That is Step 3's job now.
    };
